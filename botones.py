...
def crear_botones_trading():
    ...
    with colA:
        ...
        # CALL positivos
        with col1:
            st.button("🟢 C 100%", key="call_100",
                      on_click=agregar_operacion,
                      args=(100, 'CALL'))
            st.button("🟢 C 50%", key="call_50",
                      on_click=agregar_operacion,
                      args=(50, 'CALL'))

        # CALL negativos
        with col2:
            st.button("🔴 C -100%", key="call_menos_100",
                      on_click=agregar_operacion,
                      args=(-100, 'CALL'))
            st.button("🔴 C -50%", key="call_menos_50",
                      on_click=agregar_operacion,
                      args=(-50, 'CALL'))

        # Neutral (CALL y PUT neutrales)
        with col3:
            st.button("🟡 C 0%", key="call_0",
                      on_click=agregar_operacion,
                      args=(0, 'CALL'))
            st.button("🟡 P 0%", key="put_0",
                      on_click=agregar_operacion,
                      args=(0, 'PUT'))

        # PUT positivos
        with col4:
            st.button("🟢 P 100%", key="put_100",
                      on_click=agregar_operacion,
                      args=(100, 'PUT'))
            st.button("🟢 P 50%", key="put_50",
                      on_click=agregar_operacion,
                      args=(50, 'PUT'))

        # PUT negativos
        with col5:
            st.button("🔴 P -100%", key="put_menos_100",
                      on_click=agregar_operacion,
                      args=(-100, 'PUT'))
            st.button("🔴 P -50%", key="put_menos_50",
                      on_click=agregar_operacion,
                      args=(-50, 'PUT'))
...
def crear_botones_iv_rank():
    ...
    with colA:
        ...
        iv1.button("🟢 IV Rank 0%", key="iv_rank_0",
                   on_click=agregar_iv_rank,
                   args=("0%",))
        iv2.button("🟡 IV Rank 50%", key="iv_rank_50",
                   on_click=agregar_iv_rank,
                   args=("50%",))
        iv3.button("🔴 IV Rank 100%", key="iv_rank_100",
                   on_click=agregar_iv_rank,
                   args=("100%",))
